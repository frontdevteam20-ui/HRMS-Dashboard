      ...
      try {
        ...
        if (employee) {
          ...
          const monthAttendance = Array.from({ length: daysInMonth }, (_, i) => {
            ...
            const attendanceStatus = ['present', 'present', 'absent', 'holiday', 'week-off', 'present', 'present', 'casual-leave', 'present', 'present', 'present', 'present', 'present', 'present', 'present', 'present', 'present', 'present', 'present', 'present', 'present', 'present', 'present', 'present', 'present', 'present', 'present'];
            const loginTimes = ['10:03 AM', '09:15 AM', '--', '10:30 AM', '09:00 AM', '09:00 AM', '09:00 AM', '09:00 AM', '09:00 AM', '09:00 AM', '09:00 AM', '09:00 AM', '09:00 AM', '09:00 AM', '09:00 AM', '09:00 AM', '09:00 AM', '09:00 AM', '09:00 AM', '09:00 AM', '09:00 AM', '09:00 AM', '09:00 AM', '09:00 AM', '09:00 AM', '09:00 AM', '09:00 AM', '09:00 AM', '09:00 AM', '09:00 AM', '09:00 AM', '--'];
            const logoutTimes = ['07:10 PM', '06:15 PM', '--', '07:00 PM', '06:30 PM', '06:00 PM', '06:00 PM', '06:00 PM', '06:00 PM', '06:00 PM', '06:00 PM', '06:00 PM', '06:00 PM', '06:00 PM', '06:00 PM', '06:00 PM', '06:00 PM', '06:00 PM', '06:00 PM', '06:00 PM', '06:00 PM', '06:00 PM', '06:00 PM', '06:00 PM', '06:00 PM', '06:00 PM', '--'];
            
            const totalHours = ['9h 0m', '8h 45m', '0h 0m', '8h 30m', '9h 0m', '9h 0m', '9h 0m', '9h 0m', '9h 0m', '9h 0m', '9h 0m', '9h 0m', '9h 0m', '9h 0m', '9h 0m', '9h 0m', '9h 0m', '9h 0m', '9h 0m', '9h 0m', '9h 0m', '9h 0m', '9h 0m', '9h 0m', '9h 0m', '9h 0m'];
            ...
            return {
              ...
              remarks: getStatusRemark(attendanceStatus[i])
            };
          });
        ...
        console.log(`📊 PayrollEditScreen - Loaded employees for ${currentMonth}/${currentYear}:`, data);
        console.log(`✏️ PayrollEditScreen - Selected employee for editing:`, employee);
      } catch (error) {
