...
import { FaSearch, FaUserPlus, FaFilter, FaDownload, FaUserEdit, FaTrashAlt, FaEnvelope } from 'react-icons/fa';
...
const Employees = () => {
  ...
  const employees = [
    ...
    { id: 5, name: 'David Brown', position: 'QA Engineer', department: 'Engineering', email: 'david@example.com', status: 'Active' },
  ];
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="mt-4 sm:mt-0 flex space-x-2">
          <button className="px-4 py-2 text-sm font-medium text-white bg-primary-600 rounded-md hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 flex items-center">
